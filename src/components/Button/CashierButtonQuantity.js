...
const CashierButtonQuantity = (props) =>{
    ...
    return(
        ...
        <>
                <TextField  
                    ...
                    type = "number"
                    style={ error_quantity ? { width: '50%', backgroundColor: "#ffe8e8"} : { width: '50%'}  }
                />

                {/* {error_quantity ? "vuot ton kho" : null} */}
        </>
...
export default CashierButtonQuantity
