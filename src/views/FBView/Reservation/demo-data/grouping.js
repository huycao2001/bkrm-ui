...
export const data = [
    {
        ...
        tableId: 2,
        startDate: new Date(year, month, date, 9, 30),
        endDate: new Date(year, month, date, 11, 30),
        id: 0,
    }, {
        title: 'Book Flights to San Fran for Sales Trip',
        tableId: 1,
        startDate: new Date(year, month, date, 10, 0),
        endDate: new Date(year, month, date, 12, 0),
        id: 1,
    }, {
