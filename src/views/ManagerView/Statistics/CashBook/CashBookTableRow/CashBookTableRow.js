    ...
    return (
        ...
        {/* ROW */}
            ...
            >
                ...
                <TableCell align="left" className={colorText?null:classes.fontName}style={{color:colorText}}>{row.date?.split(" ")[0].split('-').reverse().join('/').concat("\u00a0\u00a0"+ row.date?.split(" ")[1].substr(0, 5)) }</TableCell>

                <TableCell align="left"style={{color:colorText}}>{<VNDFormat value = {row.value}/>}</TableCell>
